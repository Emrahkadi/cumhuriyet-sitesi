...
app.use(
  helmet({
    contentSecurityPolicy: {
      ...
      directives: {
        defaultSrc: ["'self'"],
        scriptSrc: ["'self'", "'unsafe-inline'", 'blob:', 'https://*.tawk.to', 'https://embed.tawk.to'],
        scriptSrcElem: ["'self'", "'unsafe-inline'", 'https://*.tawk.to', 'https://embed.tawk.to'],
        ...
        frameSrc: ["'self'", 'https://*.tawk.to', 'blob:'],
        childSrc: ["'self'", 'blob:', 'https://*.tawk.to'],
        workerSrc: ["'self'", 'blob:'],
        mediaSrc: ["'self'", 'https://*.tawk.to', 'blob:'],
        objectSrc: ["'none'"],
        baseUri: ["'self'"],
        formAction: ["'self'"]
      }
